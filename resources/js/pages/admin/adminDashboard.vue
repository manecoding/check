...
const getList = async () => {
    const respone = await axios.get("/api/checked_list");
...
const search = async () => {
    if (searchTerm.value != "") {
        try {
            const response = await axios.get("/api/search_checked_list/", {
                headers: {
        ...
        >
            <div class="flex items-center">
                <h1 class="font-semibold text-xl lg:text-2xl text-white">
                    BNI SUPER<br />
                    Mega Visitor's Day Checked List
                </h1>
            </div>
            <div class="relative">
                <input
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <button
                                class="inline-flex items-center justify-between gap-2 px-3 py-2 text-sm font-medium text-center text-white bg-blue-500 rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300"
                            >
